...
@section("content")
    <section style="padding:50px; padding-left: 300px; width: 100vw;" class="d-flex justify-content-center">
        <form style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2); padding: 20px;" class="d-flex flex-column w-50 gap-3" action="{{ route("store_services") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex gap-5">
                ...
                <div class="d-flex align-items-center gap-1">
                    ...
                    <input type="radio" name="icon" id="design" value="{{ $design }}">
                </div>
                <div class="d-flex align-items-center gap-1">
                    <label for="card">
                        <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24"  
                    ...
                    <input type="radio" name="icon" id="card" value="{{ $card }}">
                </div>
                <div class="d-flex align-items-center gap-1">
                    <label for="website">
                        <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24"  
